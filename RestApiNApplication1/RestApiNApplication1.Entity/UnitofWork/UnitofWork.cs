...
namespace RestApiNApplication1.Entity.UnitofWork
{
    public interface IUnitOfWork : IDisposable
    {
        ...
        RestApiNApplication1Context Context { get; }
        int Save();
        Task<int> SaveAsync();
    }
    ...
    {
        public RestApiNApplication1Context Context { get; }

        private Dictionary<Type, object> _repositoriesAsync;
        private Dictionary<Type, object> _repositories;
        private bool _disposed;

        public UnitOfWork(RestApiNApplication1Context context)
        {
            Context = context;
            _disposed = false;
        }
