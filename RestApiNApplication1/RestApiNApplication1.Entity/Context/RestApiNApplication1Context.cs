...
namespace RestApiNApplication1.Entity.Context
{
    public partial class RestApiNApplication1Context : DbContext
    {

        public RestApiNApplication1Context(DbContextOptions<RestApiNApplication1Context> options)
            : base(options)
        {
        }
