...
namespace RestApiNApplication2.Entity.Context
{
    public partial class RestApiNApplication2Context : DbContext
    {

        public RestApiNApplication2Context(DbContextOptions<RestApiNApplication2Context> options)
            : base(options)
        {
        }
